...
import com.example.studentmanagementapp.model.Converters
...
@Database(entities = [Student::class, Staff::class, AttendanceRecord::class, User::class], version = 3, exportSchema = false)
